document.addEventListener('DOMContentLoaded', () => {
    ...
    // 画像切り替え関連の要素
    const imageSelectButtons = document.querySelectorAll('.image-select-group button');
    ...
    // 初期状態では画像非表示を確実にする
    displayImage.classList.add('hidden-image');
    // 初期状態でbodyにwhite-screenクラスが付いていないことを確認
    body.classList.remove('white-screen');
    setTime(DEFAULT_TIME.h, DEFAULT_TIME.m, DEFAULT_TIME.s);
    requestAnimationFrame(animate);
});